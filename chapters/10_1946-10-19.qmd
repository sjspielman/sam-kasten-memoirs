...
> How I appeared for the first time in the [{{< var kuni >}}](https://web.uwm.edu/yiddish-stage/plotting-yiddish-drama/di-tsvey-kuni-leml)^[In the 1960s, this was made into an Israeli film called [_The Flying Matchmaker_](https://en.wikipedia.org/wiki/The_Flying_Matchmaker).]. -- The actor [{{< var frank-full >}}](https://www.museumoffamilyhistory.com/yt/lex/F/frank-jacob.htm). - An offer to play in a theater in [Brownsville](https://en.wikipedia.org/wiki/Brownsville,_Brooklyn#)^[Neighborhood in Brooklyn that was _extremely_ Jewish through the 1950s.]. -- Ten dollars a week^[$10 in the 1890s equates to roughly $340 today (2023)].
