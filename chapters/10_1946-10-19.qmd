...
> How I appeared for the first time in the ["The Kuni Lemels"](https://web.uwm.edu/yiddish-stage/plotting-yiddish-drama/di-tsvey-kuni-leml)^[The play "The Two Kuni Lemels" is one of Goldfaden's most famous plays. In the 1960s, it was made into an [Israeli film](https://en.wikipedia.org/wiki/The_Flying_Matchmaker).]. - The actor [Jacob Frank](https://www.museumoffamilyhistory.com/yt/lex/F/frank-jacob.htm). - An offer to play in a theater in [Brownsville](https://en.wikipedia.org/wiki/Brownsville,_Brooklyn#)^[Neighborhood in Brooklyn that was _extremely_ Jewish through the 1950s.]. - Ten dollars a week^[$10 in the 1890s equates to roughly $340 today (2023)].
