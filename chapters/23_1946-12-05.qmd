...
> [{{< var simonoff >}}](https://www.museumoffamilyhistory.com/yt/lex/S/simonoff-moshe.htm)'s constant "no" in the Hebrew Actors' Union. - [{{< var ivan-abramson >}}](https://www.museumoffamilyhistory.com/yt/lex/A/abramson-ivan.htm) and the comedian [{{< var berl-b >}}](https://www.museumoffamilyhistory.com/yt/lex/B/bernstein-berl.htm). - Why people called him {{< var b-hope >}} ^["Hope" as used here does not mean hope as in English; it means either "hup/hop!" as in, "_hup_, let's go!", or "hop" as in hopping/skipping around].
