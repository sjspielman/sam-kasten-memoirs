...
![This advertisement from September 3rd, 1903 in the {{< var forverts >}} reads:<br><br>**People's Theater**<br>{{< var mogu >}} is healthy, lively, and in good spirits to play in the People's Theater. Friday evening September 4th, Mr. {{< var mogu >}} will appear as Feitl in **{{< var immigrant >}}**.<br>[Source.](https://www.nli.org.il/en/newspapers/frw/1903/09/03/01/article/16.1)(../img/newspaper_clippings/1903-09-03_forverts.png){width="3in"}
...
The few performances he played that season in People's Theater were usually those from the old repertoire. He appeared in several roles which, in years past, he had made famous and beloved by the whole Jewish world^[Indeed, {{< var mogu >}} originated the role of [Schmendrik](https://en.wikipedia.org/wiki/Shmendrik), which in turn became a word/trope in Yiddish and now even English - all because of his acting.]. Once, when the decision was made to put on {{< var goldfaden >}}'s {{< var kuni >}}, he requested that I play the second {{< var kuni-lemel >}} - the fake one^[There is no record of this performance in the papers between 1903--1906. However, [this advertisement](https://www.nli.org.il/en/newspapers/dwt/1912/04/12/01/article/32.1/) in {{< var vahr >}} shows that {{< var mogu >}} performed in {{< var kuni >}} with Sam on April 13th, 1912 in People's Theater. This may be the performance Sam is referring to. In addition, we know from newspaper cross-referencing that, by the time {{< var mogu >}} regained his speech, Sam had in fact already left the People's Theater for the Windsor Theater (which he will describe in subsequent chapters), so the chronology is somewhat out of order here anyways. It makes sense that Sam might recall a performance in the People's Theater here.].
