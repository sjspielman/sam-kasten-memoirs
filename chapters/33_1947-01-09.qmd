...
I played in Philadelphia for three seasons[^philly], and I achieved such renown that even those who remembered me well from the early days and called me "{{< var sam >}}ke" when I was still struggling to make a name for myself, started to call me "Mr. Kestin," and I had many great fans among them.
...
![Sheet music cover for {{< var wedding-day >}} performed in Lyric Theater, picturing from left to right, {{< var clara-full >}}, {{< var kessler-full >}}, and {{< var sam >}} "Kesten." [Image source and associated sheet music](https://www.loc.gov/resource/ihas.200186076.0/).](../img/wedding-day.jpeg){width="4in"}
