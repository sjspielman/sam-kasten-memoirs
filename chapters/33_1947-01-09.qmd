...
##### _Link to [{{< var forverts >}} edition](https://www.nli.org.il/en/newspapers/frw/1947/01/09/01/)_ {.unnumbered}
...
The plan that {{< var wilner >}} made for kicking off the new season in the Thialia Theater was totally shot, because {{< var adler >}} head us off - he bought the Thalia Theater and became the new manager. Because of this, {{< var kessler >}} was suddenly left without a theater in New York - apparently just as {{< var adler >}} wanted. But {{< var wilner >}} found a solution about what to do with the whole troupe he had hired. He split the troupe in two and rented out the Lyric Theater in Brooklyn and the Liberty Theater in Brownsville, and we started the season with {{< var lateiner-full >}}'s piece {{< var wedding-day >}}^[Listen to [a song from the play](https://search.library.wisc.edu/digital/AX3TMJFTUV72UX8Y)].
