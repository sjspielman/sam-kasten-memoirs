...
In the rehearsals where {{< var thomash >}} showed us how to perform the scene, {{< var kessler >}} sat there with a sullen look on his face. Smoking a cigar which he held the whole time in the corner of his mouth, he, with implacable obstinacy, sat quietly, not saying even one word. But he watched {{< var thomash >}} directing us very closely, and when he heard us fighting in the scene, he started winking at {{< var schwartz >}}^[_William_ Schwartz] to say that the scene wasn't working this way. He made the same sort of grimace that I knew meant that if we played the scene as {{< var thomash >}} had taught us, we'd ruin the whole scene, and our roles too, because...well because it just wasn't good!
...
The scene generally worked well this way - without all the yelling and screaming, it became very moving. Without using any words, {{< var kessler >}} taught {{< var schwartz >}} and I what to do and how to behave by playing both of our roles - both the good son and the bad son. He did everything in such a supremely artistic manner.

Even {{< var thomash >}} himself had to admit that the scene was better this way and {{< var kessler >}} was right. And later when we performed the scene for an audience, they confirmed that the scene was very good - every time we played the scene, the audience applauded enthusiastically.
...
[^william]:
    Alas, {{< var sam >}}'s memory does _not_ serve, but he's close! The bad son was instead played by _{{< var william-full >}}_. In fact, {{< var forverts >}} actually issued a correction was actually issued to this end immediately after the following week's article on January 23rd:

    ::: {layout-ncol="2"}
    
    >**Not {{< var schwartz-full >}} but Willy {{< var schwartz >}}** 
    >
    > In last Thursday's article, in relaying an episode from when I played with {{< var thomash >}} in National Theater, I made an error: I meant Willy {{< var schwartz >}}, not {{< var schwartz-full >}} which was not right. {{< var schwartz-full >}} never played with {{< var thomash >}}.
