...
They bickered over it for a long time, until they decided that in the newpapers announcements, they would run four lines: two in one issue, and two others in the next issue. The first two lines would read "{{< var boris >}} and {{< var kessler-full >}}," and the other two lines would read "{{< var kessler-full >}} and {{< var boris >}}"...
