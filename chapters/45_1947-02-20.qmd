...
![Advertisement from September 25th, 1927 in the English section of {{< var forverts >}} announcing the Public Theater cast for the 1927/28 season.<br>[Source.](https://www.nli.org.il/en/newspapers/frw/1927/09/25/01/article/96)](../img/newspaper_clippings/1927-09-25_forverts.png){width="1.5in"}

At the start of the 1927 season, I was engaged to play in the New York Public Theater, and I was promised that I would be the first comedian. In other words, I would play the leading comic roles in the plays I performed in. There were two managers of the theater, {{< var goldberg-full >}} and {{< var schulman-full >}}, both honorable men and good managers who knew who to run a theater. They put together a very good troupe, and the "star" who played the lead roles was {{< var blank-full >}}. Aside from {{< var blank >}} and I in the troupe, there was also [{{< var goldenburg >}}](https://www.museumoffamilyhistory.com/yt/lex/G/goldenburg-samuel.htm) and [{{< var nathanson-full >}}](https://www.museumoffamilyhistory.com/yt/lex/N/nathanson-charles.htm).

:::

But a short time before the season started, on one fine morning, that told us the news that {{< var satz-full >}} had also been engaged to play int he Public Theater. I confess, when I heard this news I wasn't too happy because it meant that I would no longer be able to play the lead comic roles with {{< var satz >}} now on board. 

To take the audiences by storm right from the beginning, we opened the season with an operetta whose name I don't remember anymore^[According to this [advertisment in {{< var forverts >}} from September 21st 1927](https://www.nli.org.il/en/newspapers/frw/1927/09/21/01/article/77.4), the operetta was {{< var zaydes-gelibte >}}. Note that {{< var sam >}} appears in the bottom right corner the advertisement's cartoon image.]. But I do remember that the entire troupe performed in the operetta which was put together so that the two "stars" {{< var blank-full >}} and {{< var satz-full >}} wouldn't feel slighted and neither would eclipse the other.  
...
In opinion, this was one of the best characters that {{< var satz >}} ever created on the Yiddish stage. He played the role so well that after his performance, it was dangerous for other actors to play the same role because none of them - even the best - could live up to what {{< var satz >}} had created. 
...
![Image from February 24th, 1928 in {{< var morgen >}} of {{< var satz-full >}} (L) and {{< var sam >}} (R) in {{< var rabbis-son >}}.<br>[Source.](https://www.nli.org.il/en/newspapers/tjm/1928/02/24/01/article/54.1)](../img/newspaper_clippings/1928-02-24_morgen.png){width="2.5in"}
...
A series of messages were passed back and forth until {{< var satz >}}, with great difficulty, was persuaded that he should direct with piece together with {{< var samuel-rosen >}} and he should not cut parts of the piece and leave the other actors with nothing to do...

This was all in the year 1928, and I recounted this story because it is so typical of the "starism" in our little Yiddish theater world that had gotten even worse than before, after {{< var leb-full >}} changed the game with his play {{< var liovke >}}.
...
Writing these memories has brought me closer to the wider Jewish community, which I have always loved. While writing, I remembered a lot of bad things that I had forgotten, and also a lot of good things that came to my mind quite often. But there's no harm in telling both the bad and the good when recounting the entirety of a career on the stage. And believe me, if I could, I would do it all over again. It wouldn't even bother me to stand on a street corner in Philadelphia and shout at the top of my lungs, 


-- Parlor matches, two for five! Parlor matches, two for five!^[It's worth noting he originally recounted this as "three for five" back in Chapters [5](./05_1946-09-28.qmd) and [6](./06_1946-10-03.qmd).]

Just like I did some 60 years ago when I came to America with my mother, {{< var Feige >}} the {{< var Possessorka >}}, as a young man and made a living from selling matches in the street...
