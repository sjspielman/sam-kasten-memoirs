...
To take the audiences by storm right from the beginning, we opened the season with an operetta whose name I don't remember anymore[^zaydes]. Note that {{< var sam >}} appears in the bottom right corner the advertisement's cartoon image.]. But I do remember that the operetta was staged so that the two "stars" {{< var blank-full >}} and {{< var satz-full >}} wouldn't feel slighted and neither would eclipse the other.  
