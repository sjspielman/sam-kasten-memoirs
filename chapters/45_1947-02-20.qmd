...
To take the audiences by storm right from the beginning, we opened the season with an operetta whose name I don't remember anymore^[According to this [advertisement in {{< var forverts >}} from September 21st 1927](https://www.nli.org.il/en/newspapers/frw/1927/09/21/01/article/77.4), the operetta was {{< var zaydes-gelibte >}}. Note that {{< var sam >}} appears in the bottom right corner the advertisement's cartoon image.]. But I do remember that the entire troupe performed in the operetta which was put together so that the two "stars" {{< var blank-full >}} and {{< var satz-full >}} wouldn't feel slighted and neither would eclipse the other.  
